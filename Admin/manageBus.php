...
$sqls      ="SELECT * FROM `trips` where `trip_id`='$tripid'";
    ...
    if($mysqli->query($sql)===true){
          ?><script>alert('<?php echo'Your Agancye added';?>');</script><?php
                                    header('location:manageBusSeat.php?tripid='.$tripid.'&busid='.$busid.'');
                                   }else{
                    ...
                    <div class="row">
                        <div class="col s12" style="padding:0;">
                            <div class="orange darken-1 white-text center" style="border-bottom: 1px solid black; padding: 10px;">
                                <h4 style="margin:0;">Manage Seat</h4>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="row hide-on-med-and-down">
                        ...
                        <div class="row">
                            <div class="input-feild col s12 center">
                                <button class="btn btn-larger waves-effect waves-light orange darken-1" type="submit" name="bookt" style="width:80%;">Manage</button>
                            </div>
                        </div>
                    </div>
                </form>
