          ...
          <div dir="rtl" class="row">
            <div class="col s12" style="padding:0;">
              <div class="orange darken-1 white-text center" style="border-bottom: 1px solid black; padding: 10px;">
                <h4 style="margin:0;">مدينة</h4>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s12 l6">
                <input dir="ltr" name="cityen" type="text" class="validate" required>
                <label for="cityName_eng">المدينة (en)</label>
              </div>
              <div class="input-field col s12 l6">
                <input name="cityar" type="text" class="validate" required>
                <label for="cityName_arb">المدينة</label>
              </div>
            </div>
            <div class="row">
              <div class="input-feild col s12 center">
                <input type="submit" name="city" class="btn btn-larger waves-effect waves-light orange darken-1" style="width:80%;" value="إضافة">
              </div>
            </div>
          </div>
        </form>
