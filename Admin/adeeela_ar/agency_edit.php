  ...
  <main>
    ...
    <nav>
      <div class="nav-wrapper teal lighten-1">
        ...
        <ul class="left">
          <li><a class="dropdown-button waves-effect waves-light" href="#!" data-activates="dropdown1"><i class="material-icons right"
                style="margin: 0;">settings</i></a></li>
        </ul>
      </div>
    </nav>
      <?php 
          ...
          <div class="row">
            ...
            <div dir="rtl" class="row">
              ...
              <div class="input-field col s12 l6">
                <input dir="ltr" id="" type="text" class="validate">
            ...
            <div class="row">
              <div class="input-feild col s12 center">
                <button class="btn btn-larger waves-effect waves-light teal lighten-1" style="width:80%;">حفظ</button>
              </div>
            </div>
          </div>
        </form>
