...
if(isset($_POST['adds'])){
    ...
    //file uplod end
    $sql="INSERT INTO `advertisment`(`spansor`, `ura`, `adds_imag`) VALUES (N'$spansor','$urladd','$filepath')";
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 l4" dir="rtl">
                                ...
                                <label for="">كفيل<i class="red-text">*</i></label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col l4 s12"></div>
                            <div class="input-field col s12 l4" dir="rtl">
                                ...
                                <label for="">الرابط<i class="red-text">*</i></label>
                            </div>
                        </div>
                        <div class="row">
