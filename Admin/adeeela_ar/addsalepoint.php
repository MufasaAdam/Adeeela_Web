...
if(isset($_POST['addsp'])){
    ...
    if($mysqli->query($sql)===true){
                 ?>
<script>alert('<?php echo'Your Sale Point added';?>');</script>
<?php
                                   }else{
