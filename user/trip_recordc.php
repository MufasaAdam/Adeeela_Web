...
if(isset($_POST['remove'])){
    $del=$_POST['del'];
    $sql          ="UPDATE `special_trip_request` SET `status`='4' WHERE `request_id`='$del'";
    ...
    <div class="page">
        ...
        <div class="workspace z-depth-5">
            <?php
                            ...
                            ?>
            <form action="trip_recordc.php?r_id=<?php echo $rid;?>" method="post">
                ...
                <div class="row no-margin">
                    ...
                    <div class="input-field col s8 l8"> <button style="width: 100%;" class="btn waves-effect waves-light pulse blue"
                            type="submit" confirm("are you dure!"); name="remove">Clear
                        </button></div>
                    <div class="col s2 l2"></div>
                </div>
            </form>
